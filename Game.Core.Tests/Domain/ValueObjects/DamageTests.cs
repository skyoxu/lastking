...
{
    [Fact]
    public void ShouldNeverBeNegative_WhenEffectiveAmountCalculated()
    {
        // Arrange
    ...
    [InlineData(0, 0)]
    [InlineData(5, 5)]
    public void ShouldClampNegativeAndKeepPositive_WhenCalculatingEffectiveAmount(int rawAmount, int expected)
    {
        // Arrange
