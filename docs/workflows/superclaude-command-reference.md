...
| `--ui` | UI/场景架构 | Godot 场景/UI 任务 | 场景树设计、Signal 连接 |
...
| TDD 实现 (UI/场景) | `/sc:build --task 3.2 --tdd --ui --coverage-gate 85` |
