...
- Date: 2026-09-02
- Context:
  - `lastking` already has explicit repository authority across `AGENTS.md`, Taskmaster, PRD/GDD, ADR/Base/Overlay, contracts, testing rules, workflow docs, execution plans, and decision logs.
...
- Consequences:
  ...
  - Costs / risks:
    ...
    - Consumer adapters must be implemented specifically for `lastking`; Ji Mu Yun VDD/Quick Dev/Bootstrap adapters cannot be copied mechanically.
