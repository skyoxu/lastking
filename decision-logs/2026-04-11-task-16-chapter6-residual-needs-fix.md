...
- Validation: py -3 scripts/sc/llm_review_needs_fix_fast.py --task-id 16 --delivery-profile fast-ship --rerun-failing-only --max-rounds 1
- Related ADRs: none yet
- Related execution plans: none yet
- Related task id(s): `16`
- Related run id: `42b8727ebfff4564bdbdf5a582c0456c`
- Related latest.json: `logs/ci/2026-04-11/sc-review-pipeline-task-16/latest.json`
- Related pipeline artifacts: `logs/ci/2026-04-11/sc-review-pipeline-task-16-42b8727ebfff4564bdbdf5a582c0456c`
