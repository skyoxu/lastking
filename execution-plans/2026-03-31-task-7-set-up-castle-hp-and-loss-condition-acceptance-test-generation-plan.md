# Task 7 Set up castle HP and loss condition acceptance-test generation plan

- Title: Task 7 Set up castle HP and loss condition acceptance-test generation plan
- Status: active
- Branch: task/T7
- Git Head: b915923d5454dfd6304bc36d2e195769cb9bb1c3
- Goal: Control acceptance-driven test generation complexity for task 7.
- Scope: 9 missing refs across 2 test roots; seed refs: Game.Core.Tests/Services/BattleInitializationFromConfigTests.cs, Game.Core.Tests/Services/CastleCombatResolutionTests.cs, Game.Core.Tests/Services/CastleDurabilityTerminalTests.cs, ...
