# Task 35 Implement pressure-normalization.config.schema.json with baseline constants and range checks acceptance-test generation plan

- Title: Task 35 Implement pressure-normalization.config.schema.json with baseline constants and range checks acceptance-test generation plan
- Status: active
- Branch: task/T35
- Git Head: e82f51972214cde7a25b2c2820963f82a0acb9bc
- Goal: Control acceptance-driven test generation complexity for task 35.
- Scope: 2 missing refs across 1 test roots; seed refs: Game.Core.Tests/Domain/PressureNormalizationConfigSchemaTests.cs, Game.Core.Tests/Services/DeterministicSimulationConstraintTests.cs
