# Task 65 Implement Bottom-Bar Combat State And Action Readability acceptance-test generation plan

- Title: Task 65 Implement Bottom-Bar Combat State And Action Readability acceptance-test generation plan
- Status: active
- Branch: task/T65
- Git Head: 3ed4fbc5a38101bb01c3fae281ae6a7a55583cbc
- Goal: Control acceptance-driven test generation complexity for task 65.
- Scope: 4 missing refs across 1 test roots; seed refs: Tests.Godot/tests/Integration/test_battlemap_runtime_flow_bottom_bar_readability.gd, Tests.Godot/tests/Scenes/BattleMap/test_battlemap_operation_surface_semantics.gd, Tests.Godot/tests/UI/test_hud_action_icon_availability_and_cooldown_mask.gd, ...
