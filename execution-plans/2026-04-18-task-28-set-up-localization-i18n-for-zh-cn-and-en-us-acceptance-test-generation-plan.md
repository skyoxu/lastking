# Task 28 Set Up Localization (i18n) for zh-CN and en-US acceptance-test generation plan

- Title: Task 28 Set Up Localization (i18n) for zh-CN and en-US acceptance-test generation plan
- Status: active
- Branch: task/T28
- Git Head: aa8eeab185e49a614c8ca4058401cb1a51ba9a85
- Goal: Control acceptance-driven test generation complexity for task 28.
- Scope: 8 missing refs across 2 test roots; seed refs: Game.Core.Tests/Engine/CoreLoopDeterminismLocalizationTests.cs, Game.Core.Tests/Services/LocalizationLocaleValidationTests.cs, Game.Core.Tests/Services/LocalizationManagerTests.cs, ...
