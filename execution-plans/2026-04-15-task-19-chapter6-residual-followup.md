...
- Next action: py -3 scripts/sc/llm_review_needs_fix_fast.py --task-id 19 --delivery-profile fast-ship --rerun-failing-only --max-rounds 1
...
- Related decision logs: `decision-logs/2026-04-15-task-19-chapter6-residual-needs-fix.md`
