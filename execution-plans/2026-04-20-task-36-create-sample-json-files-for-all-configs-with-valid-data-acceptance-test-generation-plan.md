# Task 36 Create sample JSON files for all configs with valid data acceptance-test generation plan

- Title: Task 36 Create sample JSON files for all configs with valid data acceptance-test generation plan
- Status: active
- Branch: task/T36
- Git Head: 949846c04729c30457fef23f4f902cf8e0e1b059
- Goal: Control acceptance-driven test generation complexity for task 36.
- Scope: 2 missing refs across 1 test roots; seed refs: Game.Core.Tests/Tasks/Task36ConfigSampleArtifactsTests.cs, Game.Core.Tests/Tasks/Task36ConfigValidationFlowTests.cs
