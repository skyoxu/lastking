...
- Next action: py -3 scripts/python/dev_cli.py inspect-run --kind pipeline --latest logs/ci/2026-05-01/sc-review-pipeline-task-49/latest.json
...
- Related decision logs: `decision-logs/2026-05-02-task-49-chapter6-residual-needs-fix.md`
