# Task 16 Implement Unit Training Queue in Barracks acceptance-test generation plan

- Title: Task 16 Implement Unit Training Queue in Barracks acceptance-test generation plan
- Status: active
- Branch: task/T16
