# Task 31 Scaffold config-contract workspace on existing project acceptance-test generation plan

- Title: Task 31 Scaffold config-contract workspace on existing project acceptance-test generation plan
- Status: active
- Branch: task/T31
- Git Head: 375737cd65be8cb4976b93a017f0d3d354f86a2d
- Goal: Control acceptance-driven test generation complexity for task 31.
- Scope: 2 missing refs across 1 test roots; seed refs: Game.Core.Tests/Tasks/Task31ConfigContractWiringTests.cs, Game.Core.Tests/Tasks/Task31ConfigWorkspaceGuardrailsTests.cs
