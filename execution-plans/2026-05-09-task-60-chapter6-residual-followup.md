...
- Next action: py -3 scripts/python/dev_cli.py inspect-run --kind pipeline --latest logs/ci/2026-05-09/sc-review-pipeline-task-60/latest.json
...
- Related decision logs: `decision-logs/2026-05-09-task-60-chapter6-residual-needs-fix-2.md`
