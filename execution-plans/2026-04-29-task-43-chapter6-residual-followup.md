...
- Next action: py -3 scripts/python/dev_cli.py inspect-run --kind pipeline --latest logs/ci/2026-04-25/sc-review-pipeline-task-43/latest.json
...
- Related decision logs: `decision-logs/2026-04-29-task-43-chapter6-residual-needs-fix.md`
