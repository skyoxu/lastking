...
/// <summary>
/// Domain event: core.lastking.day.started.
/// Emitted when the simulation enters a new day phase.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed record DayStarted(
    string RunId,
    int DayNumber,
    System.DateTimeOffset StartedAt
)
{
    public const string EventType = EventTypes.LastkingDayStarted;
}
